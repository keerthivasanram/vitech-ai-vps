...
def draw(canvas, sheet_w: float, sheet_h: float, margin: float, info: dict) -> None:
    ...
    canvas.add(Text(x + 3.0, y + 5.6, COMPANY, L_TITLE, 3.6, "start", bold=True))
    canvas.add(Text(x + 3.0, y + 10.0, HEADER_ADDR, L_TITLE, 1.9, "start"))
    ...
    canvas.add(Text(x + 3.0, y + 25.4, "CLIENT", L_TITLE, 1.9, "start"))
    canvas.add(Text(x + 22.0, y + 25.4, str(info.get("client", "")), L_TITLE, 2.5, "start"))
    canvas.add(Text(x + 91.0, y + 25.4, "DRG No.", L_TITLE, 1.9, "start"))
    canvas.add(Text(x + 110.0, y + 25.4, str(info.get("ref", "")), L_TITLE, 2.5, "start"))
    ...
    for i, (label, value) in enumerate(cells):
        ...
        canvas.add(Text(cxx + 2.0, y + 32.6, label, L_TITLE, 1.9, "start"))
        canvas.add(Text(cxx + 2.0, y + 37.4, str(value), L_TITLE, 2.6, "start", bold=True))
    ...
    canvas.add(Text(x + 91.0, y + 32.6, "DRAWN", L_TITLE, 1.9, "start"))
    canvas.add(Text(x + 105.0, y + 32.6, str(info.get("drawn", "")), L_TITLE, 2.2, "start"))
    canvas.add(Text(x + 125.0, y + 32.6, "REV", L_TITLE, 1.9, "start"))
    canvas.add(Text(x + 136.0, y + 32.6, str(info.get("rev", "0")), L_TITLE, 2.2, "start"))
    canvas.add(Text(x + 91.0, y + 39.4, "CHECKED", L_TITLE, 1.9, "start"))
    canvas.add(Text(x + 110.0, y + 39.4, str(info.get("checked", "")), L_TITLE, 2.2, "start"))
    canvas.add(Text(x + 125.0, y + 39.4, str(info.get("status", "DRAFT")),
                    L_TITLE, 2.6, "start", bold=True))
